...
def get_weather(lat, lon):
    try:
        ...
        return {'description': weather_description, 'temperature_celsius': round(temp_celsius, 2) if isinstance(temp_celsius, (int, float)) else temp_celsius, 'success': True}
    except Exception as e:
        return {'error': f'Weather API failed: {str(e)}', 'success': False}
